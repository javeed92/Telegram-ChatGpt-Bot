...
export const premiumDailyMessageLimitResponse = fmt`You reached your daily limit to chat with bot,
Wait cooldown till tomorrow, or contact our ${mention(
  "Admin",
  1316429545
)}@Admin to get more appropriate plan for yourself`;
